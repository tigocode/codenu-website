...
export default function App() {
    ...
    useEffect(() => {
        // Cálculo de tempo
        const hMonthly = manualHours * 0.80 * plants; // 80% do tempo economizado
        const hAnnual = hMonthly * 12;
        setHoursMonthly(hMonthly);
        setHoursAnnual(hAnnual);

        // Cálculo Financeiro (Custo da hora técnica estimado em R$ 40)
    ...
    // Formatador de Moeda
    const formattedRoiAnnual = 'R$ ' + roiAnnual.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    const formattedRoiMonthly = 'R$ ' + roiMonthly.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    ...
    const handleFormSubmit = (e) => {
        ...
        const messageContent = `🌟 Olá, tudo bem com você? 😊\n\n🛒Desejo fazer um orçamento da plataforma Solsas para minha empresa 💥\n\n *NOME:* ${data.nome}\n *EMPRESA:* ${data.empresa}\n *TELEFONE:* ${data.whatsapp}\n *EMAIL:* ${data.email}\n *FERRAMENTA DESEJADA:* ${data.ferramenta}`;

        const encodedMessage = encodeURIComponent(messageContent);
        const phoneNumber = data.whatsapp.replace(/\D/g, ''); // Limpa formatação do número
        ...
        <div className="min-h-screen bg-slate-50 pt-32 pb-24 px-4">
            <div className="max-w-4xl mx-auto bg-white p-8 md:p-16 rounded-[40px] shadow-xl border border-slate-200">
                <button
                    ...
                    className="flex items-center gap-2 text-[#6dd7b3] font-bold mb-10 hover:text-emerald-600 transition"
                >
                ...
                <div className="space-y-8 text-slate-600 leading-relaxed">
                    <section>
                        ...
                        <p>A <strong>Elosel (Elo Soluções Energia Limpa)</strong> e a plataforma <strong>Solsas</strong> têm o compromisso de respeitar a sua privacidade e garantir o sigilo de todas as informações que você nos fornece. Esta Política de Privacidade foi elaborada em conformidade com a Lei Geral de Proteção de Dados Pessoais (LGPD - Lei nº 13.709/2018).</p>
                    </section>
    ...
    return (
        ...
        .slider-item:hover { filter: grayscale(0%); opacity: 1; }
        ...
        .animate-float-2 { animation: float-subtle 4s ease-in-out infinite 2s; }
        ...
        @keyframes fail-bar {
            0% { width: 0%; }
            40% { width: 65%; }
            50% { width: 65%; background-color: #ef4444; }
            55% { width: 0%; background-color: #ef4444; }
            100% { width: 0%; }
        }
        ...
        /* TRANSFORMAÇÃO: CAOS PARA SOLUÇÃO */
        @keyframes view-fade-1 {
            0%, 40% { opacity: 1; transform: translateY(0); visibility: visible; }
            45%, 95% { opacity: 0; transform: translateY(20px); visibility: hidden; }
            100% { opacity: 1; transform: translateY(0); visibility: visible; }
        }
        @keyframes view-fade-2 {
            0%, 40% { opacity: 0; transform: translateY(-20px); visibility: hidden; }
            45%, 95% { opacity: 1; transform: translateY(0); visibility: visible; }
            100% { opacity: 0; transform: translateY(-20px); visibility: hidden; }
        }
        .animate-view-1 { animation: view-fade-1 10s infinite; }
        .animate-view-2 { animation: view-fade-2 10s infinite; }
      `}</style>
                    ...
                    <div className="flex justify-between h-20 items-center">
                        ...
                        >
                            <div className="flex items-center text-[32px] md:text-[34px] font-[700] text-[#1f2023] logo-font mt-1">
                                <img src="https://placehold.co/80x80/transparent/1f2023?text=LOGO" alt="Logo" width={80} height={80} />
                            </div>
                        </div>

                        {/* Menu Desktop */}
                        <div className="hidden md:flex space-x-10 items-center">
                            <button onClick={() => { setActivePage('home'); setTimeout(() => document.getElementById('sobre').scrollIntoView(), 100); }} className="text-sm font-semibold text-slate-600 hover:text-[#6dd7b3] transition">A Elosel</button>
                            <button onClick={() => { setActivePage('home'); setTimeout(() => document.getElementById('solucoes').scrollIntoView(), 100); }} className="text-sm font-semibold text-slate-600 hover:text-[#6dd7b3] transition">Ecossistema</button>
                            <button onClick={() => { setActivePage('home'); setTimeout(() => document.getElementById('roi').scrollIntoView(), 100); }} className="text-sm font-semibold text-slate-600 hover:text-[#6dd7b3] transition">Calculadora</button>
                            <button onClick={() => { setActivePage('home'); setTimeout(() => document.getElementById('contato').scrollIntoView(), 100); }} className="bg-[#6dd7b3] text-[#0F172A] px-6 py-2.5 rounded-full text-sm font-bold hover:shadow-lg hover:scale-105 transition-all">Agendar Demo</button>
                        </div>
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden absolute w-full bg-white/95 backdrop-blur-xl border-b border-slate-200 shadow-2xl">
                        <div className="px-4 pt-4 pb-8 space-y-3 flex flex-col">
                            ...
                            <a onClick={() => { setActivePage('home'); setIsMobileMenuOpen(false); setTimeout(() => document.getElementById('roi')?.scrollIntoView(), 100); }} className="w-full text-left py-3 text-lg font-bold text-slate-700 hover:text-[#6dd7b3] border-b border-slate-100 transition">Calculadora</a>
                ...
                <main>
                    ...
                    <section className="pt-40 pb-20 px-4 overflow-hidden">
                        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
                            ...
                            <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-8 leading-[1.1] tracking-tight">
                                ...
                                para sua <br />
                                <span className="bg-gradient-to-br from-[#F59E0B] to-[#6dd7b3] bg-clip-text text-transparent">Prestação de Serviço Solar.</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row justify-center gap-5">
                                <a href="#contato" className="px-10 py-5 bg-[#6dd7b3] text-[#0F172A] rounded-2xl font-black text-lg shadow-xl shadow-[#6dd7b3]/30 hover:scale-105 transition-transform">Impulsionar meu Negócio</a>
                                <a href="#solucoes" className="px-10 py-5 bg-white border-2 border-slate-200 text-slate-700 rounded-2xl font-black text-lg hover:bg-slate-50 transition-all">Conhecer o Sistema</a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="clientes" className="py-12 bg-slate-50 border-y border-slate-200">
                        <div className="max-w-7xl mx-auto px-4 text-center">
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] mb-10">Quem confia na tecnologia Elosel</p>
                            ...
                            <div className="grid lg:grid-cols-2 gap-16 items-center">
                                <div>
                                    ...
                                    <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                                        A <strong>Elosel (Elo Soluções Energia Limpa)</strong> não é apenas uma empresa de software. Somos nativos do setor de energia solar. Construímos a plataforma <strong>Solsas</strong> porque sentimos na pele a falta de ferramentas eficientes no mercado para quem atua em campo.
                                    </p>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="p-6 bg-[#6dd7b3]/10 rounded-2xl border border-[#6dd7b3]/20 relative overflow-hidden">
                                            ...
                                            <p className="text-slate-700 text-sm leading-relaxed relative z-10">
                                                Criamos a Solsas para automatizar tudo o que era manual. Hoje, nosso sistema registra o tempo real de entrega, padroniza as atividades de campo e gera relatórios instantâneos, devolvendo controle e rentabilidade à sua empresa.
                                            </p>
                                        </div>
                                    </div>
                                </div>

                                {/* ANIMAÇÃO VISUAL: Transição Caos (Manual) vs Solução (Solsas) */}
                                <div className="relative h-[400px] md:h-[500px] w-full flex items-center justify-center mt-12 lg:mt-0 perspective-1000">

                                    {/* --- VISÃO 1: CAOS / INEFICIÊNCIA (Desaparece e Aparece em Loop) --- */}
                                    <div className="absolute inset-0 w-full h-full flex items-center justify-center animate-view-1">
                                        ...
                                        <div className="relative w-full max-w-md aspect-square md:aspect-auto md:h-[400px]">
                                            ...
                                            <div className="absolute -top-6 -right-4 md:-right-10 z-20 bg-slate-800/90 backdrop-blur-md border border-red-500/20 p-4 rounded-2xl shadow-xl animate-float-1 w-48">
                                    ...
                                    {/* --- VISÃO 2: SOLUÇÃO / SOLSAS (Desaparece e Aparece em Loop) --- */}
                                    <div className="absolute inset-0 w-full h-full flex items-center justify-center animate-view-2">
                                        <div className="absolute inset-0 bg-gradient-to-tr from-[#F59E0B]/20 to-[#6dd7b3]/20 blur-[80px] rounded-full"></div>
                                        <div className="absolute top-4 bg-[#6dd7b3]/10 border border-[#6dd7b3]/20 text-[#6dd7b3] text-[10px] md:text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest whitespace-nowrap z-30">
                                            O Jeito Solsas (Controle e Automação)
                                        </div>
                                        ...
                                        <div className="relative w-full max-w-md aspect-square md:aspect-auto md:h-[400px]">
                                            ...
                                            <div className="absolute -top-6 -right-4 md:-right-10 z-20 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl shadow-xl animate-float-1 w-48">
                                                <div className="flex items-center gap-3 mb-2">
                                                    ...
                                                    <div>
                                                        <div className="text-white font-black text-sm">Relatório OK</div>
                    ...
                    <section id="solucoes" className="py-24 bg-slate-50 border-t border-slate-200">
                        <div className="max-w-7xl mx-auto px-4">
                            <div className="text-center mb-20">
                                <h2 className="text-4xl font-black mb-4">O Ecossistema de Elite Solsas</h2>
                                <p className="text-slate-500 text-lg">Módulos integrados, um único objetivo: profissionalizar sua entrega.</p>
                            </div>

                            <div className="grid lg:grid-cols-3 gap-8">
                                {/* Solar Manager */}
                                <div className="p-10 bg-white rounded-3xl border border-slate-200 card-hover shadow-sm">
                                ...
                                {/* ReembolsarApp */}
                                <div className="p-10 bg-white rounded-3xl border border-slate-200 card-hover shadow-sm">
                                    <div className="w-14 h-14 bg-[#6dd7b3] rounded-2xl flex items-center justify-center mb-8 text-[#0F172A] shadow-lg shadow-[#6dd7b3]/40">
                                        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-[#6dd7b3] font-bold text-[12px] uppercase tracking-wider">Foco: Gestão e Financeiro</span>
                                </div>

                                {/* SolarVision */}
                                <div className="p-10 bg-white rounded-3xl border border-slate-200 card-hover shadow-sm relative overflow-hidden">
                                    ...
                                    <div className="w-14 h-14 bg-slate-800 rounded-2xl flex items-center justify-center mb-8 text-white shadow-lg shadow-slate-800/40">
                                        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-slate-500 font-bold text-[12px] uppercase tracking-wider">Foco: Análise e Termografia</span>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div className="bg-slate-800 p-8 md:p-12 rounded-[40px] border border-slate-700 shadow-2xl">
                                <div className="mb-12">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-3 bg-slate-700 rounded-lg appearance-none cursor-pointer accent-[#6dd7b3]"
                                    />
                                    <div className="flex justify-between mt-4">
                                        <span className="text-slate-500 font-bold">1 Usina</span>
                                        <div className="bg-[#6dd7b3] text-slate-900 px-6 py-2 rounded-full font-black text-2xl shadow-lg shadow-[#6dd7b3]/20">
                                            {plants}
                                        </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-8 mb-12 text-left">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-700 border-none rounded-2xl px-6 py-4 text-white focus:ring-2 focus:ring-[#6dd7b3] outline-none"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <div className="text-left flex flex-col justify-center">
                                            ...
                                            <div className="flex flex-col mb-4">
                                                <div className="flex items-baseline gap-2 mb-1">
                                                    <span className="text-5xl md:text-6xl font-black text-[#F59E0B]">{formattedRoiMonthly}</span>
                    ...
                    <section id="contato" className="py-24 bg-white relative">
                        <div className="max-w-7xl mx-auto px-4">
                            <div className="grid lg:grid-cols-2 gap-20 items-center">
                                <div>
                                    <h2 className="text-5xl font-black mb-8 leading-tight text-slate-900">Chegou a hora de ser <span className="text-[#F59E0B]">Referência.</span></h2>
                                    <p className="text-xl text-slate-600 mb-10 leading-relaxed">
                                        Escolha a ferramenta individual ou o **Combo Solsas** para dominar o mercado de O&M. Nossa equipe técnica está pronta para configurar sua nova central de comando.
                                    </p>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex items-start gap-4 p-4 rounded-2xl hover:bg-slate-50 transition">
                                            <div className="w-12 h-12 rounded-full bg-[#6dd7b3]/20 flex items-center justify-center text-[#6dd7b3] shrink-0">
                                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="bg-slate-900 p-10 rounded-[40px] shadow-2xl relative overflow-hidden">
                                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#6dd7b3]/20 rounded-full -mr-16 -mt-16 blur-2xl"></div>
                                    ...
                                    {!isSubmitted ? (
                                        <form onSubmit={handleFormSubmit} className="relative z-10 space-y-5">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <input name="nome" required type="text" placeholder="Nome" className="w-full bg-slate-800 border-none rounded-xl px-5 py-4 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-[#6dd7b3] outline-none" />
                                                <input name="empresa" required type="text" placeholder="Empresa" className="w-full bg-slate-800 border-none rounded-xl px-5 py-4 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-[#6dd7b3] outline-none" />
                                            </div>

                                            <input name="email" required type="email" placeholder="E-mail Corporativo" className="w-full bg-slate-800 border-none rounded-xl px-5 py-4 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-[#6dd7b3] outline-none" />

                                            <input name="whatsapp" required type="tel" placeholder="WhatsApp (com DDD)" className="w-full bg-slate-800 border-none rounded-xl px-5 py-4 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-[#6dd7b3] outline-none" />

                                            <select name="ferramenta" className="w-full bg-slate-800 border-none rounded-xl px-5 py-4 text-white focus:ring-2 focus:ring-[#6dd7b3] outline-none appearance-none">
                                                <option value="Combo Solsas">Combo Solsas (Todas as Ferramentas)</option>
                                            ...
                                            <button type="submit" className="w-full py-5 bg-[#6dd7b3] text-slate-900 rounded-xl font-black text-xl hover:bg-[#5bc5a1] shadow-xl shadow-[#6dd7b3]/20 transition-all">
                                                Começar Transformação
                                            </button>
                                        </form>
                                    ) : (
                                        <div className="relative z-10 text-center py-12">
                                            <div className="w-20 h-20 bg-[#6dd7b3] text-slate-900 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl shadow-[#6dd7b3]/40">
            ...
            {/* Footer (Aparece em ambas as telas) */}
            <footer className="py-16 bg-slate-900 border-t border-slate-800">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <div className="flex items-center justify-center gap-3 mb-8">
                        <div className="w-8 h-8 bg-gradient-to-br from-[#F59E0B] to-[#6dd7b3] rounded-lg flex items-center justify-center text-white text-2xl font-bold">S</div>
                        <div className="flex items-center text-[24px] font-[700] text-white logo-font mt-1">
                            <span>solsas</span>
                        </div>
                    </div>
                    <div className="flex justify-center space-x-8 mb-8 text-sm font-bold text-slate-400">
                        <button onClick={() => setActivePage('privacy')} className="hover:text-[#6dd7b3] transition cursor-pointer">Política de Privacidade (LGPD)</button>
                        <a href="#" className="hover:text-[#6dd7b3] transition">Termos de Uso</a>
                        <a href="#" className="hover:text-[#6dd7b3] transition">LinkedIn</a>
                    </div>
                    <p className="text-slate-500 text-[10px] tracking-widest font-black uppercase">© 2024 ELOSEL (ELO SOLUÇÕES ENERGIA LIMPA). DESENVOLVEDORA DA PLATAFORMA SOLSAS.</p>
                </div>
            </footer>
        </div>
    );
